...
//    List<Matricula> listaMatricula;
    ...
    public void registrarCurso(Integer codigoCurso, String nome, Integer quantidadeMaximaDeAlunos) {
        ...
        if (listaCurso.contains(novoCurso)) { //ARRUMAR UMA MANEIRA MAIS FACIL DE CONSULTAR LISTA POR ATRIBUTO E NÃO METODOS, SEM SEBRESCREVER O EQUALS
    ...
    public void matricularAluno(Integer codigoAluno, Integer codigoCurso) {
        ...
        if (novoCurso.getVagas() > 0) { //COMO TRATO ISSO?
            Matricula novaMatricula = new Matricula(novoAluno, novoCurso);
            System.out.println(novaMatricula.getDataDodia());
    ...
    public void alocarProfessores(Integer codigoCurso, Integer codigoProfessorTitular, Integer codigoProfessorAdjunto){
        ...
        novoCurso.setProfessorAdjunto(novoProfessorAdj);//COMO TRATAR ISSO SEM TRY CATCH
